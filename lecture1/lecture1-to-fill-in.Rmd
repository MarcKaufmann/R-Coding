...
Practice_of_writting_elements_with_underscore
...
R has reserved words which are not to be used in R. 
Examples of reserved words: if, else, repeat FALSE.
...
# Your examples below
#Error 1:
# while trying to knit I encountered this message:
#Access violation in generated code when executing data at 0x4b62429

# Attempting to reconstruct a stack trace...

 #  Frame	Code address
 #* 0x57adac0	0x4b62429 C:\PROGRA~1\RStudio\bin\pandoc\pandoc.exe+0x4762429

#Error: pandoc document conversion failed with error 11
#Execution halted

#However the solution was found on github and I read that the Pandoc was making the problems and when I ran the following command: dir <- "C:/Users/my_name/R/rstudio-pandoc" I was able to knit the HTML document.
...
#!   C:/Users/selmani_sebair/AppData/Local/MiKTeX/2.9/miktex/log/pdflatex.log

#! You may want to visit the MiKTeX project page, if you need help.

#Error: Failed to compile lecture1-to-fill-in.tex. See https://yihui.name/tinytex/r/#debugging for debugging tips. #See lecture1-to-fill-in.log for more info.
#Execution halted
...
The first line is a librarby, then the second line is a variable called eureka_or_bust which is piped to the function called collect_data() and then that is piped to the function code_1.
