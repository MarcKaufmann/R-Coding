...
# Disclaimer on use of outside sources
...
1. my score may be reduced by up to 5% if I generate large amounts of text from outside sources;
2. my score may be reduced by up to 10% if I use large amounts of outside code; 
3. my score may be reduced if I am not capable of broadly explaining in an office hour with the instructor how the code from other sources works
