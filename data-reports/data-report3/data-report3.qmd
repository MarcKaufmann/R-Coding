...
# Help from others, ChatGPT, etc

**Note:** Remove this note, but leave this section on 'Help from others, ChatGPT, etc' in the rendered report after filling it in.

**Note:** Keep one of the following sentences in the report:

1. "I discussed this report and worked with <fill-in-name-of-the-person-or-persons>. In particular for the following parts: <list-the-points-not-lines-you-needed-help>."
2. "I did not discuss this report with anyone nor work with someone else. I worked on it alone."

**Note:** Don't keep this note, but keep the next sentence.

I labeled every part of the code that I got by copying (and potentially editing) answers from StackOverflow, ChatGPT (or similar AIs), or other websites providing code, including online forums (or the lecture notes, if you blindly copy-paste without understanding). For any piece of code longer than one line, I provide the source -- e.g., the link for StackOverflow or other online forums; the prompt/screenshot used for ChatGPT; similar for others. Moreover, whenever using external code, I made sure that I at least broadly understand how it works, and include that in the comment.
...
1. my score may be reduced by up to 10% if I use large amounts of outside code; 
2. my score may be reduced if I am not capable of broadly explaining in an office hour with the instructor how the code from other sources works
    - by up to 10% if I already in my code documentation acknowledged that I do not fully understand the code;
    - by up to 20% if I do not acknowledge in the documentation that I do not fully understand the code, yet I copied it anyway.
